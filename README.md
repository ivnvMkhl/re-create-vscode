...
<p>This extension will help you create functional react component from the context menu in VS code file explorer.</p>
 ...
 - You can change the component template in VSCode settings using the reserved ${componentName} construct
 
 ![image](https://github.com/ivnvMkhl/re-create-vscode/assets/99988140/3edfb38d-810e-4d7f-a401-ce1a9e65cdc0)
